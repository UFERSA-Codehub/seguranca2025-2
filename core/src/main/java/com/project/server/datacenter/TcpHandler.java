...
public class TcpHandler implements Runnable {
    private static final Logger logger = LoggerFactory.getLogger("Datacenter.TcpHandler");
    ...
    public void run() {
        try {
            ...
            running = true;
            logger.info("[TcpHandler] Iniciando na porta {}...", port);
    ...
    private void handleConnection(Socket clientSocket) {
        ...
        try {
            ...
            logger.debug("CHALLENGE enviado para {} ({})", edgeId, peerInfo);
