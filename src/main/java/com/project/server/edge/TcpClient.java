...
public class TcpClient {
    private static final Logger logger = LoggerFactory.getLogger("DatacenterClient");
    ...
    public boolean connect() {
        ...
        try {
            ...
            logger.info("HELLO enviado para DATACENTER ({})", peerInfo);
            ...
            logger.info("CHALLENGE recebido de DATACENTER ({})", peerInfo);
            ...
            logger.info("EDGE_AUTH enviado para DATACENTER ({})", peerInfo);
            ...
            this.connected = true;
            logger.info("Autenticado e conectado ao Datacenter ({})", peerInfo);
            return true;
