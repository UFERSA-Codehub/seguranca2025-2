...
public class HttpHandler {
    private static final Logger logger = LoggerFactory.getLogger("HttpHandler");
    private static final Gson gson = new Gson();
    private static final String JWT_SECRET = "DatacenterSecretKey2025!@#$%^&*()";
    ...
    public HttpHandler(int port, DataStore dataStore, ReportService reportService, 
                       KeyManager keyManager, Map<String, String> userCredentials) {
        this.port = port;
        this.dataStore = dataStore;
        this.reportService = reportService;
        this.userCredentials = userCredentials;
        this.jwt = new JWT(JWT_SECRET, "DATACENTER");
    ...
    private void handleHandshake(HttpExchange exchange) throws IOException {
        ...
        logger.info("HELLO recebido de '{}'", clientId);
        ...
        logger.info("CHALLENGE enviado para '{}'", clientId);
    }
    ...
    private void handleAuth(HttpExchange exchange) throws IOException {
        ...
        if (!validateCredentials(username, password)) {
            logger.warn("Credenciais inválidas de '{}' - username: {}", clientId, username);
            sendAuthFail(exchange, clientId, "Credenciais inválidas");
            return;
        }

        // Passo 4 - Gerar JWT e enviar AUTH_OK
